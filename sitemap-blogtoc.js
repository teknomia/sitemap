...
// global arrays
// ---------------------------------------------------
// Reupload by Teknomia
// URL : https://teknomia.blogspot.com/2017/04/cara-membuat-sitemap-blog.html
// Date : 23-04-2017
...
function hideToc() {
  ...
  tocdiv.innerHTML = '';
  var toclink = document.getElementById("toclink");
  toclink.innerHTML = '<a href="#" onclick="scroll(0,0); showToc(); Effect.toggle('+"'toc-result','blind');"+'">» Show Table of Contents</a> <img src="https://2.bp.blogspot.com/-mfBzxoHV2so/WPm4Rla75tI/AAAAAAAADwk/IQdLf6w1aI0cXdwzmuRoSVpn4HBWYYOGQCLcB/s1600/new_1.gif"/>';
}
